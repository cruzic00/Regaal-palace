    ...
    <section className="bg-ink-soft py-16 sm:py-20 lg:py-32">
      <div className="container-x grid items-center gap-14 lg:grid-cols-2 lg:gap-20">
        ...
        <Reveal variant="right" delay={120} className="order-1 lg:order-none">
          ...
          <p className="mt-6">
            Enjoy comfortable, well-appointed rooms at The Reegal, designed for a restful and productive corporate stay. With modern amenities and a convenient location, our rooms offer the perfect balance of comfort, convenience, and relaxation for business travellers.
          </p>
