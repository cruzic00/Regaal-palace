    ...
    <section className="bg-ink-soft py-16 sm:py-20 lg:py-32">
      <div className="container-x grid items-center gap-14 lg:grid-cols-2 lg:gap-20">
        <Reveal variant="left">
          ...
          <p className="mt-6">
            At Regaal Hotels, business and comfort come together effortlessly. Designed for corporate travellers, business executives, industrial visitors, and discerning guests, we offer thoughtfully appointed rooms, modern amenities, seamless connectivity, and warm hospitality. Whether you're visiting for a meeting, an extended work assignment, or a relaxing stay, Regaal Hotels ensures a refined experience where productivity meets comfort, making every visit efficient, relaxing, and memorable..
          </p>
        ...
        <Reveal variant="right" delay={120}>
          <div className="group overflow-hidden">
            <img
              ...
              alt="Business facilities at Regaal Hotels"
              loading="lazy"
